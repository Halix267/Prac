    ...
    <div class="registration-form">
		...
		<input type="hidden" name="id" value="<?php echo isset($id) ? $id : '' ?>">
            ...
            <div class="form-group">
				...
				<input type="text" name="school_id" class="form-control item" placeholder="Enrollment Number"required value="<?php echo isset($school_id) ? $school_id : '' ?>">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
							<label for="" class="control-label" placeholder="Branch">Branch</label>
							<select name="class_id" id="class_id" placeholder ="Branch" class="form-control item select2">
								<option value=""></option>
								<?php 
